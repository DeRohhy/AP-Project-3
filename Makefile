...
ComponentManager.o: $(MANAGER_DIR)/ComponentManager.cpp $(MANAGER_DIR)/ComponentManager.h ${CORE_DIR}/Component.h ${CORE_DIR}/Package.h ${CORE_DIR}/Module.h ${OBSERVER_DIR}/SystemLogger.h
...
SystemLogger.o: ${OBSERVER_DIR}/SystemLogger.cpp ${OBSERVER_DIR}/SystemLogger.h ${OBSERVER_DIR}/Observer.h
	g++ -c ${OBSERVER_DIR}/SystemLogger.cpp -I${OBSERVER_DIR}
